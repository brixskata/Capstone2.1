        ...
        <?php if (count($favorites) > 0): ?>
            ...
            <div class="favorites-stats">
                <div class="stats-item">
                    <div class="stats-number"><?= count($favorites) ?></div>
                    <div class="stats-label">Total Favorites</div>
                </div>
                <div class="stats-item">
                    <div class="stats-number">₱<?= number_format(array_sum(array_column($favorites, 'price')), 2) ?></div>
                    <div class="stats-label">Total Value</div>
                </div>
                <div class="stats-item">
                    <div class="stats-number"><?= count(array_filter($favorites, function($p) { return $p['stock'] > 0; })) ?></div>
