        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h1 class="h3 fw-bold text-dark mb-2">
                    <i class="fa fa-user-shield me-3" style="color: #7F1734;"></i>User Permissions & Roles
                </h1>
                <p class="text-muted">Manage user roles and individual permissions</p>
            </div>
            <button class="btn" data-bs-toggle="modal" data-bs-target="#createRoleModal" style="background-color: #7F1734; color: white; border: none;">
                ...
                <form action="user_permissions.php" method="POST">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" name="update_permissions" class="btn" style="background-color: #7F1734; color: white; border: none;">Update Permissions</button>
                        </div>
                    </div>
                </form>
            </div>
        ...
        <div class="modal-dialog">
            <form action="user_permissions.php" method="POST">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                        <button type="submit" name="create_role" class="btn" style="background-color: #7F1734; color: white; border: none;">Create Role</button>
                    </div>
                </div>
            </form>
        </div>
