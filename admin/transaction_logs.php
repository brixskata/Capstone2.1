...
$query .= " GROUP BY o.orders_id, u.username, ui.email, os.status_name, o.total_price, o.delivery_option, o.created_at, pay.method, pay.proof, pay.transaction_id ORDER BY o.created_at DESC";
          ...
          <tbody>
            ...
            <?php else: ?>
              ...
              <tr class="order-row" style="transition: all 0.2s ease; cursor: pointer;" 
                ...
                <td>
                  <?php if ($order['payment_method'] == 'GCash' && !empty($order['gcash_transaction_id'])): ?>
                    <span class="badge" style="background: #e8f5e8; color: #2d5a2d; border-radius: 15px; padding: 4px 8px; font-size: 0.7rem; font-family: 'Courier New', monospace;">
