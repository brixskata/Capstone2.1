...
<body>
  ...
  <script>
    ...
    function toggleProductsView(supplierId) {
      ...
      const eyeButton = event.target.closest('button');
      ...
      if (productsRow.style.display === 'none' || productsRow.style.display === '') {
        ...
        eyeButton.title = 'Hide Products';
        eyeButton.style.background = '#0c5460';
        eyeButton.style.color = 'white';
      } else {
        // Hide products
        productsRow.style.display = 'none';
        eyeIcon.className = 'fa fa-eye';
        eyeButton.title = 'View All Products';
        eyeButton.style.background = '#d1ecf1';
        eyeButton.style.color = '#0c5460';
      }
    }
