      ...
      <div class="dropdown-menu dropdown-menu-end notification-dropdown">
        ...
        <div class="dropdown-item">
          <div class="d-flex align-items-center">
            ...
            <small>Low stock alert: 5 products</small>
          </div>
        </div>
        <div class="dropdown-item">
          <div class="d-flex align-items-center">
            <i class="fas fa-shopping-cart text-info me-2"></i>
            <small>3 new orders pending</small>
          </div>
        </div>
        <div class="dropdown-item">
          <div class="d-flex align-items-center">
    ...
    <div class="dropdown">
      ...
      <div class="dropdown-menu dropdown-menu-end">
        <div class="dropdown-item-text">
          <div class="d-flex align-items-center">
            <img src="uploads/admin-avatar.png" alt="Admin" class="admin-avatar me-2" style="width: 32px; height: 32px;" onerror="this.src='data:image/svg+xml;base64,'">
            <div>
