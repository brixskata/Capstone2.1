        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h1 class="h3 fw-bold text-dark mb-2">
                    <i class="fa fa-percent me-3" style="color: #7F1734;"></i>Discount Codes
                </h1>
                <p class="text-muted">Create and manage discount codes for customers</p>
            </div>
            <button class="btn" data-bs-toggle="modal" data-bs-target="#addDiscountModal" style="background-color: #7F1734; color: white; border: none;">
                <i class="fa fa-plus me-1"></i> Add Discount Code
            </button>
        </div>
        ...
        <div class="row mb-4">
                ...
                <div class="stats-card">
                    <div class="d-flex align-items-center">
                        <div class="flex-shrink-0">
                            <i class="fa fa-percent fa-2x" style="color: #7F1734;"></i>
                        </div>
                        <div class="flex-grow-1 ms-3">
                            <h4 class="mb-0"><?php echo count($discountCodes); ?></h4>
            ...
            <div class="col-md-3">
                <div class="stats-card">
                    <div class="d-flex align-items-center">
                        <div class="flex-shrink-0">
                            <i class="fa fa-check-circle fa-2x" style="color: #198754;"></i>
                        </div>
                        <div class="flex-grow-1 ms-3">
                            <h4 class="mb-0"><?php echo count(array_filter($discountCodes, function($code) { return $code['is_active']; })); ?></h4>
            ...
            <div class="col-md-3">
                <div class="stats-card">
                    <div class="d-flex align-items-center">
                        <div class="flex-shrink-0">
                            <i class="fa fa-times-circle fa-2x" style="color: #dc3545;"></i>
                        </div>
                        <div class="flex-grow-1 ms-3">
                            <h4 class="mb-0"><?php echo count(array_filter($discountCodes, function($code) { return !$code['is_active']; })); ?></h4>
            ...
            <div class="col-md-3">
                <div class="stats-card">
                    <div class="d-flex align-items-center">
                        <div class="flex-shrink-0">
                            <i class="fa fa-clock fa-2x" style="color: #ffc107;"></i>
                        </div>
                        <div class="flex-grow-1 ms-3">
                            <h4 class="mb-0"><?php echo count(array_filter($discountCodes, function($code) { return $code['expires_at'] && strtotime($code['expires_at']) > time(); })); ?></h4>
            ...
            <?php if (empty($discountCodes)): ?>
                <div class="col-12">
                    <div class="text-center py-5">
                        ...
                        <button class="btn" data-bs-toggle="modal" data-bs-target="#addDiscountModal" style="background-color: #7F1734; color: white; border: none;">
                            <i class="fa fa-plus me-1"></i> Add First Discount Code
                        </button>
                    </div>
                </div>
            <?php else: ?>
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="discount-card">
                            <div class="d-flex justify-content-between align-items-start mb-3">
                                <h5 class="fw-bold mb-0"><?php echo htmlspecialchars($discount['code']); ?></h5>
                                <div class="dropdown">
            ...
            <form action="discount_codes.php" method="POST" id="discountForm">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn" id="submitBtn" style="background-color: #7F1734; color: white; border: none;">Add Discount Code</button>
                    </div>
                </div>
            </form>
        </div>
