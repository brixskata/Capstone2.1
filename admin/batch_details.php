    ...
    <div class="col-md-6">
        ...
        <table class="table table-sm">
            ...
            <tr>
                ...
                <td><?= $batch['quantity_received'] ?> <?= htmlspecialchars($batch['uom_name']) ?></td>
            </tr>
            <tr>
                <td class="fw-semibold">Quantity Remaining:</td>
                <td>
                    <span class="fw-bold"><?= $batch['quantity_remaining'] ?> <?= htmlspecialchars($batch['uom_name']) ?></span>
                    ...
                    <tbody>
                        <?php foreach ($movements as $movement): ?>
                            <tr>
                                ...
                                <td>
                                    <span class="fw-semibold"><?= $movement['quantity'] ?></span>
                                </td>
                                <td>
