...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['payment_method'])) {
    ...
    if (isset($_POST['delivery_option']) && $_POST['delivery_option'] === 'delivery') {
        if (isset($_POST['address_option']) && $_POST['address_option'] === 'new') {
            ...
            $selected_address_stmt = $pdo->prepare("SELECT * FROM addresses WHERE address_id = :address_id AND user_id = :user_id");
            $selected_address_stmt->execute(['address_id' => $address_id, 'user_id' => $user_id]);
            $selected_address = $selected_address_stmt->fetch(PDO::FETCH_ASSOC);
            
            if ($selected_address) {
                $delivery_address = $selected_address['address_line'];
                $delivery_city = $selected_address['city'];
                $delivery_postal_code = $selected_address['postal_code'];
                ...
                // Fallback to default address if selected address not found
                                    ...
                                    <div class="row g-3">
                                        <div class="col-12">
                                            ...
                                            <div class="position-relative">
                                                <input type="text" name="delivery_address" id="delivery_address" class="form-control" placeholder="Start typing your address..." autocomplete="off">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-12">
                                            ...
                                            <input type="text" name="gcash_transaction_id" class="form-control" 
                                                   placeholder="Enter your GCash transaction ID (e.g., 1234567890)" 
                                                   pattern="[0-9]+" 
                                                   title="Please enter a valid transaction ID (numbers only)">
                                            <small class="form-text text-muted">
                                                <i class="fas fa-info-circle me-1"></i>
                                                You can find this in your GCash transaction history or receipt
                                            </small>
                                        </div>
                                        <div class="col-12">
