...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        ...
        $stmt = $pdo->prepare("INSERT INTO email_verification (email, otp, expires_at, created_at) VALUES (?, ?, ?, NOW())");
        ...
        // Recipients
        $mail->setFrom('brixquils16@gmail.com', 'BROWSIBUY');
        ...
        <div style='font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;'>
            <h2 style='color: #ff6a00;'>Email Verification</h2>
            <p>Your OTP verification code is:</p>
            <div style='background-color: #f5f5f5; padding: 20px; text-align: center; margin: 20px 0;'>
                <h1 style='color: #ff6a00; font-size: 32px; letter-spacing: 5px; margin: 0;'>{$otp}</h1>
            </div>
